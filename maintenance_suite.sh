#!/bin/bash
# ==========================================
# System Maintenance Suite (Student Project)
# Author: Abhaya Sahoo
# Description: Automates backups, system updates,
# and log cleanup with a simple menu interface.
# ==========================================
...
backup_system() {
    ...
    # List of folders to back up (check if they exist)
    FOLDERS=(
        "$HOME/Documents"
        "$HOME/Desktop"
        "$HOME/Downloads"
    ...
    # Clean backups and logs older than 7 days
